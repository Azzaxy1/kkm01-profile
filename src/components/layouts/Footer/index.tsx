...
const Footer = () => {
  return (
    <>
      <section className="grid py-6 bg-background px-6 lg:px-16 gap-4 2xl:px-72 grid-cols-1 md:grid-cols-3">
        <article className="flex flex-row items-center">
          <Image src={images.Logo} alt="Logo Image" width={60} />
          <div className="flex flex-col">
            <h1 className="text-2xl sm:text-4xl text-primary font-semibold">
              KKM 01 UNBAJA
            </h1>
        ...
        <article>
          <h2 className="text-2xl underline decoration-dashed underline-offset-8 mb-2 sm:text-2xl text-primary font-semibold">
            Alamat Posko
          </h2>
        ...
        <article>
          ...
          <div className="flex flex-row">
            ...
            >
              <FaSquareInstagram className="w-10 h-10 hover:text-secondary" />
            </Link>
            <Link
              href={
            ...
            >
              <MdEmail className="w-10 h-10 hover:text-secondary" />
            </Link>
            <Link
              href={
            ...
            >
              <AiFillTikTok className="w-10 h-10 hover:text-secondary" />
            </Link>
          </div>
        </article>
      </section>
